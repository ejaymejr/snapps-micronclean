...
//			echo '<Br>';
			...
			if (in_array($cdate, $wtmp['date']))
			{
				...
				if (is_null($inSumm))
				{
					//                    $att = (($gethol && $wtmp['no_hours'][$apos] < 12) ||
					//                    	   ( ($getlev) && ( (strtolower($getlev) != 'leave without pay') || (strtolower($getlev) != 'others(basic only)') )) )
					//                    	   ? TkDtrsummaryPeer::FLAG_PRESENT : TkDtrsummaryPeer::FLAG_ABSENT;    //------------ attendance
