...
?>
 <table class="table contentBox">
    ...
    <tr class="">
        ...
        <td width="25%" class="fg-white bg-cyan alignCenter alignMiddle" nowrap>RATING</td>
        <td width="20%" class="fg-white bg-cyan alignCenter alignMiddle" nowrap>RECOMMENDATION</td>
    </tr>
    ...
    <tr>
        ...
        <td width="25%" class=" alignLeft alignMiddle" nowrap>
        	<?php echo input_tag('recommend_' . $r->getId() , $sf_params->get('recommend_' . $r->getId()) )?></td>
    </tr>
    <?php  endforeach; ?>
</table>