...
<ul>
	<li  class="active"><a href="<?php echo url_for('documentChange/supplierDocumentSearch') ?>">Supplier Document Search</a></li>
...
<?php 
   	if (isset($pager)):
		$filename = PagerJson::SearchSupplierDocument($pager);
