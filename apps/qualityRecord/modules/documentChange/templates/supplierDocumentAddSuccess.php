...
$(function(){
	$("#searchCAPA").on('click', function(){
		employeelist = '';
		seq = 1;
		var opts = $('#capa_report_no')[0].options;
...
<ul>
	...
	<li class="active"><a href="<?php echo url_for('documentChange/supplierDocumentAdd') ?>">Add Supplier Document</a></li>
	<li><a href="<?php echo url_for('documentChange/supplierDocumentApproveSearch') ?>">Approve Document</a></li>
	<li></li>
</ul>
</nav>
<form name="FORMadd" id="IDFORMadd"
	action="<?php echo url_for('documentChange/supplierDocumentAdd').'?id=' . $sf_params->get('id') ?>"
	method="post">
		...
		<table width="100%" class="table bordered" >
			...
			<tr>
				<td class="FORMcell-left FORMlabel" nowrap><label>CAPA REPORT NO</label></td>
				<td class="FORMcell-right" nowrap>
				<?php
					echo HTMLLib::CreateSelectWithSerch('capa_report_no', $sf_params->get('capa_report_no'), $capaList, 'span3');
				?>
				</td>
				<td class="FORMcell-right alignLeft" colspan="3">
				</td>
			...
			<tr>
				...
				<td class="FORMcell-right" colspan="2" nowrap>
				<?php
					echo HTMLLib::CreateSubmitButton('savedocument', 'Save Supplier Document');
				?></td>
			</tr>			
		</table>
