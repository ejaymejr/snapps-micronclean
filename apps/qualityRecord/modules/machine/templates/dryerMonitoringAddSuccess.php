...
<form id="reading" method="post" action="<?php echo url_for("machine/dryerMonitoringAdd?id=". $sf_params->get('id') ) ?>" >
...
<tr>
	<td colspan="3" >
		<nav class="breadcrumbs">
			...
			<li class=" "><a id="save" href="<?php echo url_for('machine/dryerMonitoringSearch') ?>" class="" >Search Dryer Monitoring Record</a></li>
			<li><a href="#">&nbsp;</a></li>
			</ul>
		</nav
	</td>
...
<div class="panel">
	<div class="panel-header bg-teal fg-white">
	Dryer Temperature Sheet
	</div>
