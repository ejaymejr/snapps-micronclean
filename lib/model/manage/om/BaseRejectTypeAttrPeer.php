...
abstract class BaseRejectTypeAttrPeer {
	...
	const CLASS_DEFAULT = 'lib.model.manage.RejectTypeAttr';
	...
	{
		include_once 'lib/model/manage/map/RejectTypeAttrMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.manage.map.RejectTypeAttrMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/manage/map/RejectTypeAttrMapBuilder.php';
	Propel::registerMapBuilder('lib.model.manage.map.RejectTypeAttrMapBuilder');
}
