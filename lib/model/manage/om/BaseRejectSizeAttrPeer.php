...
abstract class BaseRejectSizeAttrPeer {
	...
	const CLASS_DEFAULT = 'lib.model.manage.RejectSizeAttr';
	...
	{
		include_once 'lib/model/manage/map/RejectSizeAttrMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.manage.map.RejectSizeAttrMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/manage/map/RejectSizeAttrMapBuilder.php';
	Propel::registerMapBuilder('lib.model.manage.map.RejectSizeAttrMapBuilder');
}
