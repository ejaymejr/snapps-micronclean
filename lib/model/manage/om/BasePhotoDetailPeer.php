...
abstract class BasePhotoDetailPeer {
	...
	const CLASS_DEFAULT = 'lib.model.manage.PhotoDetail';
	...
	{
		include_once 'lib/model/manage/map/PhotoDetailMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.manage.map.PhotoDetailMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/manage/map/PhotoDetailMapBuilder.php';
	Propel::registerMapBuilder('lib.model.manage.map.PhotoDetailMapBuilder');
}
