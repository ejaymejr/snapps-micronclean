...
abstract class BaseRejectRejectAttrPeer {
	...
	const CLASS_DEFAULT = 'lib.model.manage.RejectRejectAttr';
	...
	{
		include_once 'lib/model/manage/map/RejectRejectAttrMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.manage.map.RejectRejectAttrMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/manage/map/RejectRejectAttrMapBuilder.php';
	Propel::registerMapBuilder('lib.model.manage.map.RejectRejectAttrMapBuilder');
}
