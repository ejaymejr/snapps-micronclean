...
abstract class BaseEmailHistoryPeer {
	...
	const CLASS_DEFAULT = 'lib.model.manage.EmailHistory';
	...
	{
		include_once 'lib/model/manage/map/EmailHistoryMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.manage.map.EmailHistoryMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/manage/map/EmailHistoryMapBuilder.php';
	Propel::registerMapBuilder('lib.model.manage.map.EmailHistoryMapBuilder');
}
