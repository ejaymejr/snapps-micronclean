...
abstract class BaseRejectDepartmentAttrPeer {
	...
	const CLASS_DEFAULT = 'lib.model.manage.RejectDepartmentAttr';
	...
	{
		include_once 'lib/model/manage/map/RejectDepartmentAttrMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.manage.map.RejectDepartmentAttrMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/manage/map/RejectDepartmentAttrMapBuilder.php';
	Propel::registerMapBuilder('lib.model.manage.map.RejectDepartmentAttrMapBuilder');
}
