...
abstract class BaseRejectCustomerAttrPeer {
	...
	const CLASS_DEFAULT = 'lib.model.manage.RejectCustomerAttr';
	...
	{
		include_once 'lib/model/manage/map/RejectCustomerAttrMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.manage.map.RejectCustomerAttrMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/manage/map/RejectCustomerAttrMapBuilder.php';
	Propel::registerMapBuilder('lib.model.manage.map.RejectCustomerAttrMapBuilder');
}
