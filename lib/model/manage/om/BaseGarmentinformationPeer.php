...
abstract class BaseGarmentinformationPeer {
	...
	const CLASS_DEFAULT = 'lib.model.manage.Garmentinformation';
	...
	{
		include_once 'lib/model/manage/map/GarmentinformationMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.manage.map.GarmentinformationMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/manage/map/GarmentinformationMapBuilder.php';
	Propel::registerMapBuilder('lib.model.manage.map.GarmentinformationMapBuilder');
}
