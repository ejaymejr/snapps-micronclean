...
abstract class BaseRejectShiftAttrPeer {
	...
	const CLASS_DEFAULT = 'lib.model.manage.RejectShiftAttr';
	...
	{
		include_once 'lib/model/manage/map/RejectShiftAttrMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.manage.map.RejectShiftAttrMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/manage/map/RejectShiftAttrMapBuilder.php';
	Propel::registerMapBuilder('lib.model.manage.map.RejectShiftAttrMapBuilder');
}
